...
const pageDescription =
  "Understand the limits of Asphalt Calculator estimates, regional price data, contractor guidance, engineering advice, and the site's affiliate policy.";

export const metadata = buildMetadata({
  title: "Asphalt Calculator Estimate and Price Disclaimer",
    ...
    <>
      <StructuredData
        data={[
          ...
          webPageSchema({ name: "Asphalt Calculator Disclaimer", description: pageDescription, path })
        ]}
      />
      <section className="px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base leading-7 text-zinc-600">
              This site does not currently publish affiliate links, sponsored placements, or other paid referrals.
            </p>
          </div>
        </div>
      </section>
